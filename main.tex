...
\pagestyle{fancy}
\fancyfoot{}
\fancyhead[L]{Saratov State University: Afanasyev, Balandin, Mironov}
\fancyhead[R]{\thepage}
...
\subsection{Поиск экстремума функции целого аргумента}
\inputminted[breaklines]{cpp}{Scripts/Basic algorithms/ternary_search.cpp}
\subsection{Поиск экстремума функции вещественного аргумента}
\inputminted[breaklines]{cpp}{Scripts/Basic algorithms/ternary_search_real.cpp}
...
\subsection{Подсчёт циклов длины 3}
\inputminted[breaklines]{cpp}{Scripts/Graph theory/triangles.cpp}
...
\subsection{Полиномиальный хэш}
\inputminted[breaklines]{cpp}{Scripts/String algorithms/single_hash.cpp}
\subsection{Двойной полиномиальный хэш}
\inputminted[breaklines]{cpp}{Scripts/String algorithms/double_hash.cpp}
...
\subsubsection{Присваивание в точке, сумма на отрезке}
\inputminted[breaklines]{cpp}{Scripts/Data structures/sum_segment_tree.cpp}
...
\subsubsection{Персистентный стек}
\inputminted[breaklines]{cpp}{Scripts/Data structures/persistent_stack.cpp}
\subsubsection{Персистентное дерево отрезков}
\inputminted[breaklines]{cpp}{Scripts/Data structures/persistent_segment_tree.cpp}
